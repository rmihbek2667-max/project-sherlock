...
class Settings(BaseSettings):
    ...
    # Channel subscription gate — leave channel_id empty to disable the feature entirely.
    # channel_id: the channel's @username (public) or numeric -100xxxxxxxxxx ID (private).
    # The bot MUST be an admin of this channel to check membership.
    channel_id: str = ""
